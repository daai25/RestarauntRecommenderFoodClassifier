...
The dataset can be viewed in the following directory: [dataset](https://github.com/daai25/RestarauntRecommenderFoodClassifier/tree/main/modelling/food_or_not_food/dataset).
