...
├── restaurants_Bern.json
├── restaurants_Freiburg.json
├── restaurants_Genf.json
├── restaurants_Glarus.json
├── restaurants_Graubünden.json
├── restaurants_Jura.json
├── restaurants_Luzern.json
├── restaurants_Neuenburg.json
...
├── restaurants_Tessin.json
├── restaurants_Thurgau.json
├── restaurants_Uri.json
├── restaurants_Waadt.json
├── restaurants_Wallis.json
...
- With URL: 5138 (48.21%)
- With cuisine type: 5039 (47.28%)
- With URL and cuisine type: 2984 (28.00%)
```
...
This leads to the following normalized cuisine types with 208 unique entries:
```
afghan
african
american
