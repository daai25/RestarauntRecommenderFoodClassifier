# src/resnet_loader/resnet50_loader.py
import os
import torch
...
def load_resnet50_model(model_path: str, device: str=None, out_features: int=2) -> tuple[nn.Module, torch.device, transforms.Compose]:
    """
    Load a pre-trained ResNet50 model from a specified path and prepare it for inference.

    Args:
        model_path (str): Path to the pre-trained ResNet50 model file.
